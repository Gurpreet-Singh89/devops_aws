...
#### From Jenkins home page select "New Item"
   ...
   - *Source Code Management:*
      - Repository: `https://gitlab.com/gurpreetsingh89/devops_aws.git`
  ...
  - *Post-build Actions*  
    - Send build artifacts over SSH  
      - *SSH Publishers*  
	       - Exec command: 
                ```sh 
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-OldMonk-deployment.yml;
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-OldMonk-service.yml;
                ```
Save and run the job.
